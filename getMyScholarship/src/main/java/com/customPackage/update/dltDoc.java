...
public class dltDoc {
    ...
    public static void dltScheme(int test,mongoConnect mongoDB){
        ...
        if (test == 1){
            ...
            System.out.println("Now we will delete the previously added document based on following filters : ");
        ...
        Document dltDoc = new Document("Department",DepartmentName)
        ...
        Bson update = Updates.pull("Scholarships.$[schObj].Category.$[catObj].Income.$[incObj].Religion.$[relObj].Schemes", dltDoc);
